...
-- our own modules
-------------------------------------------------------------------------------
local nb = import("navbar_python")


-- The name displayed in the sidebar as well as buffer list
...
function init()
    ...
    -- Set the style for the displayed tree ("basic" or "polished")
    config.RegisterCommonOption("navbar", "treestyle", "basic")
